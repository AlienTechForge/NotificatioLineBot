...
- **path 不含 query string、不含網域**。`/api/v1/notifications`，不是
  `https://notif.azndev.com/api/v1/notifications`
...
```
POST https://notif.azndev.com/api/v1/notifications
...
```
GET https://notif.azndev.com/api/v1/notifications/{notificationId}
```
...
```
GET https://notif.azndev.com/api/v1/whoami
```
...
const BASE = "https://notif.azndev.com";
...
function Send-NotifyLine {
    param(
        ...
        [string] $Target   = "OWNER",
        [string] $Base     = "https://notif.azndev.com",
...
public final class NotifyLineClient {
    ...
    private static final String BASE = "https://notif.azndev.com";
