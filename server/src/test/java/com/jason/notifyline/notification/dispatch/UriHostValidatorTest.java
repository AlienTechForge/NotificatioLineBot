...
class UriHostValidatorTest {
    ...
    private static final UriHostValidator VALIDATOR = withHosts("example.com, azndev.com");
    ...
    void allowListWhitespace_isTrimmed() {
        UriHostValidator v = withHosts("  example.com ,  azndev.com  ");

        assertThatCode(() -> v.validate(msg("uri", "https://azndev.com/x")))
                .doesNotThrowAnyException();
    }
    ...
    void appProperties_parsesAllowList() {
        assertThat(new AppProperties("", "", "Example.COM, , azndev.com ,").allowedUriHostList())
                .containsExactly("example.com", "azndev.com");
